...
const experiences = [
    {
        ...
        technologies: ["Micro Frontend", "Typescript", "Javascript", "HTML", "CSS", "TailwindCss", "ReactJs", "NextJs", "Mantine", "Ant Design"]
    },
    {
        key: "primetech",
        period: "2022 - 2023",
        ...
        technologies: ["Typescript", "Javascript", "HTML", "CSS", "TailwindCss", "ReactJs", "NextJs", "Material UI", "Ant Design"]
    },
    {
        key: "kolayyolculuk",
        period: "2022",
...
const TimelineItem = ({ data, index }: TimelineItemProps) => {
    ...
    return (
        ...
        >
            {/* Timeline görsellerini sadece büyük ekranlarda göster */}
